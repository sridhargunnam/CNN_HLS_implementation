set C_TypeInfoList {{ 
"conv" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"a": [[], {"array": [ {"array": ["0", [11]]}, [11]]}] }, {"b": [[], {"array": [ {"array": ["0", [11]]}, [11]]}] }, {"c": [[],"0"] }],[],""], 
...
set C_modelArgList {
	{ a int 32 unused {array 121 { } 0 1 }  }
	{ b int 32 unused {array 121 { } 0 1 }  }
	{ c int 32 unused  }
}
set C_modelArgMapList {[ 
	{ "Name" : "a", "interface" : "memory", "bitwidth" : 32, "direction" : "NONE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 10,"step" : 1},{"low" : 0,"up" : 10,"step" : 1}]}]}]} , 
 	{ "Name" : "b", "interface" : "memory", "bitwidth" : 32, "direction" : "NONE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "b","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 10,"step" : 1},{"low" : 0,"up" : 10,"step" : 1}]}]}]} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "b", "Type" : "Memory", "Direction" : "X"},
...
set ArgLastReadFirstWriteLatency {
	conv {
		...
		b {Type X LastRead -1 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	b { ap_memory {  { b_address0 mem_address 1 7 }  { b_ce0 mem_ce 1 1 }  { b_we0 mem_we 1 1 }  { b_d0 mem_din 1 32 }  { b_q0 mem_dout 0 32 }  { b_address1 mem_address 1 7 }  { b_ce1 mem_ce 1 1 }  { b_we1 mem_we 1 1 }  { b_d1 mem_din 1 32 }  { b_q1 mem_dout 0 32 } } }
