set C_TypeInfoList {{ 
"conv" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"a": [[], {"reference":  {"array": ["0", [11,11]]}}] }, {"b": [[], {"reference":  {"array": ["0", [11,11]]}}] }, {"c": [[],{ "pointer": "0"}] }],[],""], 
...
set C_modelArgList {
	{ a int 32 regular {array 121 { 1 3 } 1 1 }  }
	{ b int 32 regular {array 121 { 1 3 } 1 1 }  }
	{ c int 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "a", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 10,"step" : 1},{"low" : 0,"up" : 10,"step" : 1}]}]}]} , 
 	{ "Name" : "b", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "b","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 10,"step" : 1},{"low" : 0,"up" : 10,"step" : 1}]}]}]} , 
