...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("b_address1", 7, hls_out, 1, "ap_memory", "mem_address", 1),
	Port_Property("b_ce1", 1, hls_out, 1, "ap_memory", "mem_ce", 1),
	Port_Property("b_we1", 1, hls_out, 1, "ap_memory", "mem_we", 1),
	Port_Property("b_d1", 32, hls_out, 1, "ap_memory", "mem_din", 1),
